...
############################################################################
{ haskell-nix, gitignore-nix, compiler-nix-name }:
...
let
  project = haskell-nix.project {
    ...
    sha256map = {
      ...
      "https://github.com/input-output-hk/plutus.git"."00e7cc3fce4d3af6e8a59be8ddaa108a7ae1964d" =
        "0j0whcws81l7hyg84hz155xgqzi55nslbjjg6gr2jd1n4g78vyjc";
