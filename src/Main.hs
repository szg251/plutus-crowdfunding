...
instance HasDefinitions StarterContracts where
    getDefinitions = [ GameContract ]
    getSchema = \case
        GameContract -> Builtin.endpointsToSchemas @Crowdfunding.GameSchema
    getContract = \case
        GameContract -> SomeBuiltin (Crowdfunding.game @ContractError)


handlers :: SimulatorEffectHandlers (Builtin StarterContracts)
handlers =
    Simulator.mkSimulatorHandlers @(Builtin StarterContracts) def
